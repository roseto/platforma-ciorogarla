...
<Container class="prose">
	...
	<p>
		Pentru ștergerea unui cont, contactați-ne la <a href="mailto:contact@profitery.eu.org">contact@profitery.eu.org</a>.
	</p>

	<h2>Analitică și performanță</h2>

	<p>
		Folosim propriul sistem de analitica bazat pe <a href="https://umami.is">umami</a> pentru a aduna DATE ANONIME despre
